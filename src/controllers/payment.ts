...
export const createPaymentIntent = TryCatch(async (
    ...
    if(!amount) throw new ErrorHandler("Please Enter Amount", 400);
...
export const newCoupon = TryCatch(async (
    ...
    if(!coupon || !amount) throw new ErrorHandler("Please Enter All Fields", 400);
...
export const getAllCoupons = TryCatch(async (
    req:Request, 
    res:Response, 
    next:NextFunction
) => {
...
export const discount = TryCatch(async (
    ...
    if(!couponCode) throw new ErrorHandler("Invalid Coupon", 400);
...
export const deleteCoupon = TryCatch(async (
